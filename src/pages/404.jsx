            ...
            <main className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mx-auto max-w-xl py-16 sm:py-24">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-lg text-gray-500 dark:text-slate-200">The page you are looking for could not be found.</p>
                    </div>
                    <div className="mt-12">
                        <h2 className="text-base font-semibold text-gray-500 dark:text-slate-200">Popular pages</h2>
                            ...
                            {links.map((link, linkIdx) => (
                                <li key={linkIdx} className="relative flex items-start space-x-4 py-6">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        ...
                                        <p className="text-base text-gray-500 dark:text-slate-400">{link.description}</p>
                                    </div>
